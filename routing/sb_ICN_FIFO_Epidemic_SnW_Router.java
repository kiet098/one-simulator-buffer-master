...
public class sb_ICN_FIFO_Epidemic_SnW_Router extends ActiveRouter {
	...
	public static final String ICN_HYBRID_NS = "sb_ICN_FIFO_Epidemic_SnW_Router";
	 ...
	 */
	public sb_ICN_FIFO_Epidemic_SnW_Router(Settings s) {
		super(s);
	 ...
	 */
	protected sb_ICN_FIFO_Epidemic_SnW_Router(sb_ICN_FIFO_Epidemic_SnW_Router r) {
		super(r);
	...
	@Override
	public sb_ICN_FIFO_Epidemic_SnW_Router replicate() {
		return new sb_ICN_FIFO_Epidemic_SnW_Router(this);
	}
