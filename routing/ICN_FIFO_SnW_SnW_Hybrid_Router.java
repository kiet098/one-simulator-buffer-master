...
public class ICN_FIFO_SnW_SnW_Hybrid_Router extends ActiveRouter {
	/** identifier for the initial number of copies setting ({@value})*/ 
	public static final String NROF_COPIES = "nrofCopies";
	/** identifier for the binary-mode setting ({@value})*/ 
	public static final String BINARY_MODE = "binaryMode";
	/** SprayAndWait router's settings name space ({@value})*/ 
	public static final String ICN_HYBRID_NS = "ICN_FIFO_SnW_SnW_Hybrid_Router";
	 ...
	 */
	public ICN_FIFO_SnW_SnW_Hybrid_Router(Settings s) {
		super(s);
	 ...
	 */
	protected ICN_FIFO_SnW_SnW_Hybrid_Router(ICN_FIFO_SnW_SnW_Hybrid_Router r) {
		super(r);
	...
	@Override
	public ICN_FIFO_SnW_SnW_Hybrid_Router replicate() {
		return new ICN_FIFO_SnW_SnW_Hybrid_Router(this);
	}
